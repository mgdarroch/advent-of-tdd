...
public class TestElfShould {
    ...
    void compare_return_positive_value_for_elf_with_more_total_calories() {
        Elf chunkyElf = new Elf();
        Elf skinnyElf = new Elf();
        chunkyElf.addCalories(1000);
        int result = chunkyElf.compareTo(skinnyElf);
    ...
    void compare_zero_for_equal_elf() {
        Elf elf1 = new Elf();
        Elf elf2 = new Elf();
        int result = elf1.compareTo(elf2);
